...
- A **TURN Relay** interface for clients that can't reach the video bridge directly.
...
2. Add a clearnet public domain to the **TURN Relay** interface so participants behind restrictive NAT or firewalls can fall back to TURN.
